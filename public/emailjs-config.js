...
function initializeEmailJS() {
    // Verificamos si la librería emailjs está cargada
    if (typeof emailjs !== 'undefined') {
        emailjs.init(EMAILJS_CONFIG.PUBLIC_KEY);
        console.log("✅ EmailJS inicializado correctamente.");
    } else {
        console.error("❌ La librería EmailJS no se ha cargado. Verifica el script en el HTML.");
    }
}
...
// --- EJECUCIÓN ---
// Ejecutamos la inicialización inmediatamente para evitar el error "Public key required"
initializeEmailJS();